...
Core Features¶
Feature	Description
📝 Report lost items	Description, category, location,  photo
🔍 Search and  location, 
✅ Item claimed
...
Minimum 3 sample items
Working matching algorithm

i used html,css,python language

i faced many error in backend and some syntax error while building the application
